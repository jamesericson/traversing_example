...
// bellow: by selecting the "parent" of "this" the line, aka the "li", that the button was on is made purple
...
// bellow: by going up 3 parents we went from "button" to "ls" to "ul" to "body" from here we can now "find" the "h1" and affect it
